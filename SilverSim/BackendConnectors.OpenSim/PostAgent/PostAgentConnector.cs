...
{
    public abstract class PostAgentConnector : IPlugin
    {
        public abstract void PostAgent(
            CircuitInfo circuitInfo,
            AuthorizationServiceInterface.AuthorizationData authData);

        public virtual void Startup(ConfigurationLoader loader)
        {
            ConfigurationLoader.FeaturesTable[typeof(PostAgentConnector)] = "Post Agent Connector";
        }
    }
}
