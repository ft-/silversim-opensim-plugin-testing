    ...
    public sealed class RobustAvatarConnector : AvatarServiceInterface, IPlugin
    {
        ...
        public override Dictionary<string, string> this[UUID avatarID]
        {
            get
            {
                ...
                Map map;
                using(Stream s = new HttpClient.Post(m_AvatarURI, post) { TimeoutMs = TimeoutMs }.ExecuteStreamRequest())
                {
        ...
        public override List<string> this[UUID avatarID, IList<string> itemKeys]
        {
            ...
            set
            {
                ...
                Map map;
                using (Stream s = new HttpClient.Post(m_AvatarURI, "application/x-www-form-urlencoded", outStr.ToString())
                {
                    TimeoutMs = TimeoutMs
